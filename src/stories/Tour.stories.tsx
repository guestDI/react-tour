...
import { TourProvider, Tour, useTour, tourManager } from '../index';
import type { TourStep, ContentType } from '../types';
...
const tourSteps: TourStep[] = [
  ...
  },
  {
    ...
    content: {
      type: 'text',
      value: 'Check out our amazing features!',
    } as ContentType,
    placement: 'right',
  },
  {
    ...
    content: {
      type: 'text',
      value: 'Configure your settings here.',
    } as ContentType,
    placement: 'left',
  },
  {
    ...
    content: {
      type: 'text',
      value: 'This section shows custom content rendering.',
    } as ContentType,
    placement: 'top',
  },
];

// Initialize the global manager with the steps
tourManager.initialize(tourSteps);
...
// Basic example with TourProvider
export const BasicWithProvider: Story = {
  render: () => {
    const { start } = useTour();
    return (
      <>
...
// Basic example without TourProvider
export const BasicWithoutProvider: Story = {
  render: () => {
    const { start } = useTour();
    return (
      <>
  ...
  render: () => {
    ...
    return (
      <>
          ...
          >
            Start Tour (Custom Styling)
          </button>
          <Tour
            overlayClassName="!bg-black/40 tour-overlay-blur"
            tooltipClassName="!bg-rose-50 !border-rose-200 !text-rose-900 dark:!bg-gray-800 dark:!border-rose-900 dark:!text-rose-100"
            buttonClassName="!bg-rose-500 !text-white hover:!bg-rose-600"
            buttonContainerClassName="!border-t !border-rose-200 dark:!border-rose-800 !pt-4 !mt-4"
            highlightTarget={{
...
// Example using global manager
export const WithGlobalManager: Story = {
  render: () => {
    const { start } = useTour();
    return (
      <>
...
// Example with slide animation (default)
  ...
  render: () => {
    ...
    return (
      <>
        <button
          onClick={start}
          className="w-full px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-medium rounded-lg transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
        >
          Start Tour (Bounce Animation)
        </button>
        <Tour
          animation="bounce"
          overlayClassName="!bg-black/40 tour-overlay-blur"
          tooltipClassName="!bg-purple-50 !border-purple-200 !text-purple-900 dark:!bg-gray-800 dark:!border-purple-900 dark:!text-purple-100"
          buttonClassName="!bg-purple-500 !text-white hover:!bg-purple-600"
          buttonContainerClassName="!border-t !border-purple-200 dark:!border-purple-800 !pt-4 !mt-4"
          highlightTarget={{
            className: '!bg-purple-500/10 !border-purple-500/30 !shadow-purple-500/20',
    ...
    return (
      <>
        <button
          ...
          className="w-full px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-medium rounded-lg transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
        >
          Start Tour (Fade Animation)
        </button>
        <Tour
          animation="fade"
          overlayClassName="!bg-black/40 tour-overlay-blur"
          tooltipClassName="!bg-emerald-50 !border-emerald-200 !text-emerald-900 dark:!bg-gray-800 dark:!border-emerald-900 dark:!text-emerald-100"
          buttonClassName="!bg-emerald-500 !text-white hover:!bg-emerald-600"
          buttonContainerClassName="!border-t !border-emerald-200 dark:!border-emerald-800 !pt-4 !mt-4"
          highlightTarget={{
            className: '!bg-emerald-500/10 !border-emerald-500/30 !shadow-emerald-500/20',
            style: {
              borderRadius: '0.75rem',
...
// Example with custom button rendering
export const WithCustomButtonRendering: Story = {
  render: () => {
    const { start } = useTour();
    return (
      <>
        <button
          ...
          className="w-full px-6 py-3 bg-gradient-to-r from-violet-500 to-purple-500 hover:from-violet-600 hover:to-purple-600 text-white font-medium rounded-lg transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
        >
          Start Tour (Custom Buttons)
        </button>
        <Tour
          animation="fade"
          overlayClassName="!bg-black/40 tour-overlay-blur"
          tooltipClassName="!bg-violet-50 !border-violet-200 !text-violet-900 dark:!bg-gray-800 dark:!border-violet-900 dark:!text-violet-100"
          buttonConfig={{
            primary: {
            ...
            container: {
              render: ({ onNext, onBack, onSkip, onComplete, isFirstStep, isLastStep, currentStep, totalSteps }) => (
                <div className="flex flex-col gap-4 mt-4 pt-4 border-t border-violet-200 dark:border-violet-800">
                  <div className="flex justify-between items-center">
                    {currentStep !== undefined && totalSteps !== undefined && (
          ...
          highlightTarget={{
            className: '!bg-violet-500/10 !border-violet-500/30 !shadow-violet-500/20',
            style: {
              borderRadius: '0.75rem',
...
// Example with Tailwind class overrides
export const WithTailwindOverrides: Story = {
  render: () => {
    const { start } = useTour();
    return (
      <>
